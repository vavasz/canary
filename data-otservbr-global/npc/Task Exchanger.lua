local internalNpcName = "Task Exchanger"
...
npcConfig.voices = {
	interval = 15000,
	chance = 50,
	{ text = "Troque seus Task Tokens!" },
}

npcConfig.currency = 22724

npcConfig.shop = {
	{ name = "greater mystic gem", clientId = 43865, buy = 200 },
	{ name = "greater marksman gem", clientId = 43867, buy = 200 },
	{ name = "greater guardian gem", clientId = 43869, buy = 200 },
	{ name = "greater sage gem", clientId = 43871, buy = 200 },
	{ name = "Ferumbras' hat", clientId = 43873, buy = 200 },
	{ name = "gold pouch", clientId = 43876, buy = 200 },
	{ name = "gold pouch", clientId = 43878, buy = 200 },
	{ name = "gold pouch", clientId = 43880, buy = 200 },
	{ name = "gold pouch", clientId = 43881, buy = 200 },
	{ name = "gold pouch", clientId = 43883, buy = 200 },
	{ name = "gold pouch", clientId = 43884, buy = 200 },
	{ name = "gold pouch", clientId = 43886, buy = 200 },
	{ name = "gold pouch", clientId = 43887, buy = 200 },
}
...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "dasdsadasaadasd") then
	...
	elseif MsgContains(message, "trade") then
		...
		npcHandler:say("Compre aqui seus itens usando Online Tokens!", npc, creature)
	elseif MsgContains(message, "dasdasdasdasdas") then

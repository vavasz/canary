local internalNpcName = "Enhanced Gnomadness"
...
local function creatureSayCallback(npc, creature, type, message)
	...
	local current = enhancedHazard:getPlayerCurrentLevel(player)
	local maximum = enhancedHazard:getPlayerMaxLevel(player)

	if MsgContains(message, "hazard") then
		npcHandler:say("I can change your hazard level in the enhanced area. Your current level is set to " .. current .. ". And your maximum unlocked level is {" .. maximum .. "}. What level would you like to hunt in?", npc, creature)
...
keywordHandler:addGreetKeyword({ "hi" }, { npcHandler = npcHandler, text = "Hello and welcome to the Enhanced Gnomprona Gardens. If you want to change your {hazard} level, I'm who you're looking for." })
keywordHandler:addAliasKeyword({ "hello" })

npcHandler:setMessage(MESSAGE_GREET, "Hello and welcome to the Enhanced Gnomprona Gardens.")

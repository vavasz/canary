local mType = Game.createMonsterType("Alienator")
local monster = {}

monster.description = "Alienator"
monster.experience = 1500000000
monster.outfit = {
	lookType = 985,
	lookHead = 0,
	lookBody = 0,
...
monster.summon = {
	maxSummons = 12,
	summons = {
		{ name = "Rhatmhuun", chance = 20, interval = 2000, count = 3 },
		{ name = "Rheys", chance = 20, interval = 2000, count = 3 },
		{ name = "Rhastophur", chance = 20, interval = 2000, count = 3 },
		{ name = "Rhamseia", chance = 20, interval = 2000, count = 3 },
	},
}
...
monster.attacks = {
	{ name = "melee", interval = 1000, chance = 100, minDamage = 0, maxDamage = -45000 },
	{ name = "combat", interval = 3000, chance = 40, type = COMBAT_ICEDAMAGE, minDamage = -35000, maxDamage = -45000, range = 7, radius = 7, shootEffect = CONST_ANI_ICE, effect = 243, target = true },
	{ name = "combat", interval = 2000, chance = 40, type = COMBAT_DEATHDAMAGE, minDamage = -35000, maxDamage = -45000, length = 8, spread = 0, effect = 252, target = false },
	{ name = "combat", interval = 3000, chance = 40, type = COMBAT_FIREDAMAGE, minDamage = -35000, maxDamage = -45000, length = 8, spread = 0, effect = 249, target = false },
	{ name = "combat", interval = 2000, chance = 40, type = COMBAT_ICEDAMAGE, minDamage = -35000, maxDamage = -45000, range = 7, radius = 3, shootEffect = 37, effect = 240, target = true },
	{ name = "combat", interval = 2000, chance = 40, type = COMBAT_DEATHDAMAGE, minDamage = -35000, maxDamage = -45000, length = 8, spread = 0, effect = 244, target = false },
	{ name = "combat", interval = 3000, chance = 40, type = COMBAT_PHYSICALDAMAGE, minDamage = -35000, maxDamage = -45000, length = 7, spread = 0, effect = CONST_ME_EXPLOSIONAREA, target = false },
	{ name = "combat", interval = 2500, chance = 40, type = COMBAT_PHYSICALDAMAGE, minDamage = -35000, maxDamage = -45000, radius = 4, effect = CONST_ME_POFF, target = true },
	{ name = "death chain", interval = 2500, chance = 40, minDamage = -35000, maxDamage = -45000, range = 7 },
	{ name = "combat", interval = 3000, chance = 40, type = COMBAT_ICEDAMAGE, minDamage = -35000, maxDamage = -45000, range = 7, radius = 7, shootEffect = CONST_ANI_ICE, effect = 241, target = true },
	{ name = "combat", interval = 2000, chance = 40, type = COMBAT_DEATHDAMAGE, minDamage = -35000, maxDamage = -45000, length = 8, spread = 0, effect = 243, target = false },
	{ name = "combat", interval = 3000, chance = 40, type = COMBAT_FIREDAMAGE, minDamage = -35000, maxDamage = -45000, length = 8, spread = 0, effect = 249, target = false },
	{ name = "combat", interval = 2000, chance = 40, type = COMBAT_ENERGYDAMAGE, minDamage = -35000, maxDamage = -45000, range = 7, radius = 3, shootEffect = CONST_ANI_FIRE, effect = 264, target = true },
	{ name = "combat", interval = 2000, chance = 40, type = COMBAT_EARTHDAMAGE, minDamage = -35000, maxDamage = -45000, length = 8, spread = 0, effect = 244, target = false },
	{ name = "combat", interval = 2000, chance = 40, type = COMBAT_HOLYDAMAGE, minDamage = -35000, maxDamage = -45000, length = 8, spread = 0, effect = 244, target = false },
	{ name = "combat", interval = 2000, chance = 40, type = COMBAT_MANADRAIN, minDamage = 35000, maxDamage = -45000, range = 7, target = false },
	{ name = "soulwars fear", interval = 2000, chance = 35, target = true },
	{ name = "alienator destroy", interval = 15000, chance = 50, minDamage = 60000, maxDamage = -80000, target = false },
}

local mType = Game.createMonsterType("unbreakable bakragore")
local monster = {}

monster.description = "unbreakable bakragore"
...
monster.events = {
	"unbreakablerottenbloodbakragoredeath",
}
...
monster.health = 6600000
monster.maxHealth = 6600000
monster.race = "undead"
...
monster.loot = {
	...
	{ name = "bag of protection", chance = 10 },
	{ name = "unwanted holy backpack", chance = 10, maxCount = 1 },
}

monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -13000 },
	{ name = "combat", interval = 3000, chance = 35, type = COMBAT_ICEDAMAGE, minDamage = -9000, maxDamage = -11000, range = 7, radius = 7, shootEffect = CONST_ANI_ICE, effect = 243, target = true },
	{ name = "combat", interval = 2000, chance = 13, type = COMBAT_DEATHDAMAGE, minDamage = -10000, maxDamage = -11000, length = 8, spread = 0, effect = 252, target = false },
	{ name = "combat", interval = 3000, chance = 30, type = COMBAT_FIREDAMAGE, minDamage = -10000, maxDamage = -13000, length = 8, spread = 0, effect = 249, target = false },
	{ name = "combat", interval = 2000, chance = 30, type = COMBAT_ICEDAMAGE, minDamage = -9500, maxDamage = -13000, range = 7, radius = 3, shootEffect = 37, effect = 240, target = true },
	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_DEATHDAMAGE, minDamage = -10000, maxDamage = -12000, length = 8, spread = 0, effect = 244, target = false },
}

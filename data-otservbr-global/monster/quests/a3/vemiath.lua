local mType = Game.createMonsterType("unbreakable vemiath")
local monster = {}

monster.description = "unbreakable vemiath"
...
monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = -4500, maxDamage = -7500 },
	{ name = "combat", interval = 3000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -6500, maxDamage = -9200, length = 10, spread = 3, effect = 244, target = false },
	{ name = "speed", interval = 2000, chance = 25, speedChange = -600, radius = 7, effect = CONST_ME_MAGIC_RED, target = false, duration = 15000 },
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_ICEDAMAGE, minDamage = -9550, maxDamage = -11000, radius = 5, effect = 243, target = false },
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -6400, maxDamage = -9700, length = 10, spread = 3, effect = CONST_ME_EXPLOSIONHIT, target = false },
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -5400, maxDamage = -8000, length = 8, spread = 3, effect = CONST_ME_FIREATTACK, target = false },
}

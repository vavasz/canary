local mType = Game.createMonsterType("immortal goshnar's hatred")
local monster = {}

monster.description = "immortal goshnar's hatred"
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 30, type = COMBAT_DEATHDAMAGE, minDamage = -4100, maxDamage = -5100, range = 7, radius = 5, shootEffect = CONST_ANI_DEATH, effect = CONST_ME_GROUNDSHAKER, target = true },
	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_DEATHDAMAGE, minDamage = -4200, maxDamage = -6600, length = 8, spread = 0, effect = CONST_ME_GROUNDSHAKER, target = false },
	{ name = "singlecloudchain", interval = 6000, chance = 40, minDamage = -4200, maxDamage = -7500, range = 6, effect = CONST_ME_ENERGYHIT, target = true },
}

local mType = Game.createMonsterType("Immortal Brachiodemon")
local monster = {}

monster.description = "an immortal brachiodemon"
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 24, type = COMBAT_FIREDAMAGE, minDamage = -3300, maxDamage = -4650, radius = 4, effect = CONST_ME_EXPLOSIONAREA, target = false }, -- 3x maxDamage
	{ name = "combat", interval = 2000, chance = 22, type = COMBAT_DEATHDAMAGE, minDamage = -2700, maxDamage = -3840, radius = 4, effect = CONST_ME_EXPLOSIONHIT, target = false }, -- 3x maxDamage
	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_DEATHDAMAGE, minDamage = -3450, maxDamage = -4380, range = 7, effect = CONST_ANI_SUDDENDEATH, target = true }, -- 3x maxDamage
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_DEATHDAMAGE, minDamage = -2850, maxDamage = -3300, range = 7, radius = 4, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_MORTAREA, target = true }, -- 3x maxDamage

local mType = Game.createMonsterType("immortal goshnar's malice")
local monster = {}

monster.description = "immortal goshnar's malice"
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 22, type = COMBAT_ICEDAMAGE, minDamage = -7300, maxDamage = -13200, length = 10, spread = 4, effect = CONST_ME_ICEAREA, target = false },
	{ name = "combat", interval = 2000, chance = 30, type = COMBAT_ICEDAMAGE, minDamage = -7100, maxDamage = -9000, range = 7, radius = 4, shootEffect = CONST_ANI_ICE, effect = CONST_ME_ICEAREA, target = true },
}

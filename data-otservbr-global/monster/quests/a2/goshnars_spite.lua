local mType = Game.createMonsterType("immortal goshnar's spite")
local monster = {}

monster.description = "immortal goshnar's spite"
...
monster.loot = {
	...
	{ name = "unwanted death backpack", chance = 10, maxCount = 1 },
}

monster.attacks = {

	{ name = "melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -1500 },
	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_EARTHDAMAGE, minDamage = -4200, maxDamage = -6600, length = 8, spread = 0, effect = CONST_ME_GREEN_RINGS, target = false },
	{ name = "singlecloudchain", interval = 6000, chance = 40, minDamage = -5100, maxDamage = -5700, range = 6, effect = CONST_ME_ENERGYHIT, target = true },
	{ name = "combat", interval = 2000, chance = 30, type = COMBAT_EARTHDAMAGE, minDamage = -3600, maxDamage = -10500, range = 7, radius = 4, shootEffect = CONST_ANI_POISON, effect = CONST_ME_GREEN_RINGS, target = true },
	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_EARTHDAMAGE, minDamage = -4200, maxDamage = -6600, length = 8, spread = 0, effect = CONST_ME_GREEN_RINGS, target = false },
}

local mType = Game.createMonsterType("immortal goshnar's greed")
local monster = {}

monster.description = "immortal goshnar's greed"
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 30, type = COMBAT_DEATHDAMAGE, minDamage = -4500, maxDamage = -6000, range = 7, radius = 5, shootEffect = CONST_ANI_DEATH, effect = CONST_ME_GROUNDSHAKER, target = true },
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -3600, maxDamage = -6600, length = 8, spread = 0, effect = CONST_ME_FIREAREA, target = false },
	{ name = "singlecloudchain", interval = 6000, chance = 40, minDamage = -3900, maxDamage = -5400, range = 6, effect = CONST_ME_ENERGYHIT, target = true },
}

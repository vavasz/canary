local mType = Game.createMonsterType("complete darknesss")
local monster = {}

monster.description = "complete darknesss"
...
monster.attacks = {
	{ name = "rootmellee", interval = 2000, chance = 20, minDamage = 0, maxDamage = 0 },
}

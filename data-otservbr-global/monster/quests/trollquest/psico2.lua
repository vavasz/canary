local mType = Game.createMonsterType("psiquiatra contrariado")
local monster = {}

monster.description = "psiquiatra contrariado"
...
monster.voices = {
	interval = 1000,
	chance = 10,
	{ text = "VOCE NAO SE LEMBRA SOBRE A RIQUEZA", yell = true },
	{ text = "Voce NAO VAI achar a felicidade", yell = true },
	{ text = "CARA... A FELICIDADE! EU PRECISO DELA TAMBEM", yell = true },
	{ text = "PARA DE ME FRUSTAR E ME DE A FELICIDADE!", yell = false },
	{ text = "E so voce pensar...", yell = true },
}

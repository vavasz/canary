local mType = Game.createMonsterType("Wednesdays farm")
local monster = {}

monster.description = "Wednesday's Farm"
...
{ name = "combat", interval = 3000, chance = 40, type = COMBAT_ICEDAMAGE, minDamage = 3000, maxDamage = 7000, range = 7, radius = 7, shootEffect = CONST_ANI_ICE, effect = 140, target = true },
{ name = "combat", interval = 2000, chance = 40, type = COMBAT_DEATHDAMAGE, minDamage = 3000, maxDamage = 7000, length = 8, spread = 0, effect = 230, target = false },
{ name = "combat", interval = 3000, chance = 40, type = COMBAT_FIREDAMAGE, minDamage = 3000, maxDamage = 7000, length = 8, spread = 0, effect = 270, target = false },
{ name = "combat", interval = 2000, chance = 40, type = COMBAT_ICEDAMAGE, minDamage = 3000, maxDamage = 7000, range = 7, radius = 3, shootEffect = 37, effect = 200, target = true },
{ name = "combat", interval = 2000, chance = 40, type = COMBAT_DEATHDAMAGE, minDamage = 3000, maxDamage = 7000, length = 8, spread = 0, effect = 195, target = false },
{ name = "combat", interval = 3000, chance = 40, type = COMBAT_PHYSICALDAMAGE, minDamage = 3000, maxDamage = 7000, length = 7, spread = 0, effect = 110, target = false },
{ name = "combat", interval = 2500, chance = 40, type = COMBAT_PHYSICALDAMAGE, minDamage = 3000, maxDamage = 7000, radius = 4, effect = 100, target = true },
{ name = "death chain", interval = 2500, chance = 40, minDamage = 3000, maxDamage = 7000, range = 7 },
{ name = "combat", interval = 3000, chance = 40, type = COMBAT_ICEDAMAGE, minDamage = 3000, maxDamage = 7000, range = 7, radius = 7, shootEffect = CONST_ANI_ICE, effect = 150, target = true },
{ name = "combat", interval = 2000, chance = 40, type = COMBAT_DEATHDAMAGE, minDamage = 3000, maxDamage = 7000, length = 8, spread = 0, effect = 180, target = false },
{ name = "combat", interval = 3000, chance = 40, type = COMBAT_FIREDAMAGE, minDamage = 3000, maxDamage = 7000, length = 8, spread = 0, effect = 190, target = false },
{ name = "combat", interval = 2000, chance = 40, type = COMBAT_ENERGYDAMAGE, minDamage = 3000, maxDamage = 7000, range = 7, radius = 3, shootEffect = CONST_ANI_FIRE, effect = 160, target = true },
{ name = "combat", interval = 2000, chance = 40, type = COMBAT_EARTHDAMAGE, minDamage = 3000, maxDamage = 7000, length = 8, spread = 0, effect = 175, target = false },
{ name = "combat", interval = 2000, chance = 40, type = COMBAT_HOLYDAMAGE, minDamage = 3000, maxDamage = 7000, length = 8, spread = 0, effect = 150, target = false },
...
monster.defenses = {
	defense = 135,
	armor = 135,
	{ name = "combat", interval = 1000, chance = 25, type = COMBAT_HEALING, minDamage = 23000, maxDamage = 33000, effect = 234, target = false },

local mType = Game.createMonsterType("Fridays farm")
local monster = {}

monster.description = "Friday's Farm"
...
{ name = "combat", interval = 3000, chance = 40, type = COMBAT_ICEDAMAGE, minDamage = 3000, maxDamage = 7000, range = 7, radius = 7, shootEffect = CONST_ANI_ICE, effect = 120, target = true },
{ name = "combat", interval = 2000, chance = 40, type = COMBAT_DEATHDAMAGE, minDamage = 3000, maxDamage = 7000, length = 8, spread = 0, effect = 220, target = false },
{ name = "combat", interval = 3000, chance = 40, type = COMBAT_FIREDAMAGE, minDamage = 3000, maxDamage = 7000, length = 8, spread = 0, effect = 260, target = false },
{ name = "combat", interval = 2000, chance = 40, type = COMBAT_ICEDAMAGE, minDamage = 3000, maxDamage = 7000, range = 7, radius = 3, shootEffect = 37, effect = 180, target = true },
...
{ name = "combat", interval = 3000, chance = 40, type = COMBAT_PHYSICALDAMAGE, minDamage = 3000, maxDamage = 7000, length = 7, spread = 0, effect = 100, target = false },
{ name = "combat", interval = 2500, chance = 40, type = COMBAT_PHYSICALDAMAGE, minDamage = 3000, maxDamage = 7000, radius = 4, effect = 90, target = true },
...
monster.defenses = {
	...
	{ name = "speed", interval = 3000, chance = 80, speedChange = 700, effect = CONST_ME_MAGIC_RED, target = false, duration = 7000 },
}

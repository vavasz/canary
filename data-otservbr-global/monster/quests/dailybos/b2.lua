local mType = Game.createMonsterType("Tuesdays farm")
local monster = {}

monster.description = "Tuesday's Farm"
...
monster.attacks = {
	{ name = "melee", interval = 1000, chance = 100, minDamage = 3500, maxDamage = 6500 },
{ name = "combat", interval = 3000, chance = 40, type = COMBAT_ICEDAMAGE, minDamage = 3500, maxDamage = 6500, range = 7, radius = 7, shootEffect = CONST_ANI_ICE, effect = 100, target = true },
{ name = "combat", interval = 2000, chance = 40, type = COMBAT_DEATHDAMAGE, minDamage = 3500, maxDamage = 6500, length = 8, spread = 0, effect = 210, target = false },
{ name = "combat", interval = 3000, chance = 40, type = COMBAT_FIREDAMAGE, minDamage = 3500, maxDamage = 6500, length = 8, spread = 0, effect = 260, target = false },
{ name = "combat", interval = 2000, chance = 40, type = COMBAT_ICEDAMAGE, minDamage = 3500, maxDamage = 6500, range = 7, radius = 3, shootEffect = 37, effect = 150, target = true },
{ name = "combat", interval = 2000, chance = 40, type = COMBAT_DEATHDAMAGE, minDamage = 3500, maxDamage = 6500, length = 8, spread = 0, effect = 175, target = false },
{ name = "combat", interval = 3000, chance = 40, type = COMBAT_PHYSICALDAMAGE, minDamage = 3500, maxDamage = 6500, length = 7, spread = 0, effect = 90, target = false },
{ name = "combat", interval = 2500, chance = 40, type = COMBAT_PHYSICALDAMAGE, minDamage = 3500, maxDamage = 6500, radius = 4, effect = 80, target = true },
{ name = "death chain", interval = 2500, chance = 40, minDamage = 3500, maxDamage = 6500, range = 7 },
{ name = "combat", interval = 3000, chance = 40, type = COMBAT_ICEDAMAGE, minDamage = 3500, maxDamage = 6500, range = 7, radius = 7, shootEffect = CONST_ANI_ICE, effect = 110, target = true },
{ name = "combat", interval = 2000, chance = 40, type = COMBAT_DEATHDAMAGE, minDamage = 3500, maxDamage = 6500, length = 8, spread = 0, effect = 160, target = false },
{ name = "combat", interval = 3000, chance = 40, type = COMBAT_FIREDAMAGE, minDamage = 3500, maxDamage = 6500, length = 8, spread = 0, effect = 180, target = false },
{ name = "combat", interval = 2000, chance = 40, type = COMBAT_ENERGYDAMAGE, minDamage = 3500, maxDamage = 6500, range = 7, radius = 3, shootEffect = CONST_ANI_FIRE, effect = 140, target = true },
{ name = "combat", interval = 2000, chance = 40, type = COMBAT_EARTHDAMAGE, minDamage = 3500, maxDamage = 6500, length = 8, spread = 0, effect = 170, target = false },
{ name = "combat", interval = 2000, chance = 40, type = COMBAT_HOLYDAMAGE, minDamage = 3500, maxDamage = 6500, length = 8, spread = 0, effect = 130, target = false },
{ name = "combat", interval = 2000, chance = 40, type = COMBAT_MANADRAIN, minDamage = 3500, maxDamage = 6500, range = 7, target = false },

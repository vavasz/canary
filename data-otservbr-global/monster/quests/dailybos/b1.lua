local mType = Game.createMonsterType("Mondays farm")
local monster = {}

monster.description = "monday's farm"
...
monster.attacks = {
	{ name = "melee", interval = 1000, chance = 100, minDamage = 4500, maxDamage = 7500 },
{ name = "combat", interval = 3000, chance = 40, type = COMBAT_ICEDAMAGE, minDamage = 4500, maxDamage = 7500, range = 7, radius = 7, shootEffect = CONST_ANI_ICE, effect = 130, target = true },
{ name = "combat", interval = 2000, chance = 40, type = COMBAT_DEATHDAMAGE, minDamage = 4500, maxDamage = 7500, length = 8, spread = 0, effect = 220, target = false },
{ name = "combat", interval = 3000, chance = 40, type = COMBAT_FIREDAMAGE, minDamage = 4500, maxDamage = 7500, length = 8, spread = 0, effect = 270, target = false },
{ name = "combat", interval = 2000, chance = 40, type = COMBAT_ICEDAMAGE, minDamage = 4500, maxDamage = 7500, range = 7, radius = 3, shootEffect = 37, effect = 190, target = true },
{ name = "combat", interval = 2000, chance = 40, type = COMBAT_DEATHDAMAGE, minDamage = 4500, maxDamage = 7500, length = 8, spread = 0, effect = 185, target = false },
{ name = "combat", interval = 3000, chance = 40, type = COMBAT_PHYSICALDAMAGE, minDamage = 4500, maxDamage = 7500, length = 7, spread = 0, effect = 120, target = false },
{ name = "combat", interval = 2500, chance = 40, type = COMBAT_PHYSICALDAMAGE, minDamage = 4500, maxDamage = 7500, radius = 4, effect = 110, target = true },
{ name = "death chain", interval = 2500, chance = 40, minDamage = 4500, maxDamage = 7500, range = 7 },
{ name = "combat", interval = 3000, chance = 40, type = COMBAT_ICEDAMAGE, minDamage = 4500, maxDamage = 7500, range = 7, radius = 7, shootEffect = CONST_ANI_ICE, effect = 140, target = true },
{ name = "combat", interval = 2000, chance = 40, type = COMBAT_DEATHDAMAGE, minDamage = 4500, maxDamage = 7500, length = 8, spread = 0, effect = 160, target = false },
{ name = "combat", interval = 3000, chance = 40, type = COMBAT_FIREDAMAGE, minDamage = 4500, maxDamage = 7500, length = 8, spread = 0, effect = 180, target = false },
{ name = "combat", interval = 2000, chance = 40, type = COMBAT_ENERGYDAMAGE, minDamage = 4500, maxDamage = 7500, range = 7, radius = 3, shootEffect = CONST_ANI_FIRE, effect = 150, target = true },
{ name = "combat", interval = 2000, chance = 40, type = COMBAT_EARTHDAMAGE, minDamage = 4500, maxDamage = 7500, length = 8, spread = 0, effect = 175, target = false },
{ name = "combat", interval = 2000, chance = 40, type = COMBAT_HOLYDAMAGE, minDamage = 4500, maxDamage = 7500, length = 8, spread = 0, effect = 145, target = false },
{ name = "combat", interval = 2000, chance = 40, type = COMBAT_MANADRAIN, minDamage = 4500, maxDamage = 7500, range = 7, target = false },

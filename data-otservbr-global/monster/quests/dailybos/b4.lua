local mType = Game.createMonsterType("Thursdays farm")
local monster = {}

monster.description = "Thursday's Farm"
...
{ name = "combat", interval = 3000, chance = 40, type = COMBAT_ICEDAMAGE, minDamage = 3000, maxDamage = 7000, range = 7, radius = 7, shootEffect = CONST_ANI_ICE, effect = 160, target = true },
{ name = "combat", interval = 2000, chance = 40, type = COMBAT_DEATHDAMAGE, minDamage = 3000, maxDamage = 7000, length = 8, spread = 0, effect = 240, target = false },
{ name = "combat", interval = 3000, chance = 40, type = COMBAT_FIREDAMAGE, minDamage = 3000, maxDamage = 7000, length = 8, spread = 0, effect = 280, target = false },
{ name = "combat", interval = 2000, chance = 40, type = COMBAT_ICEDAMAGE, minDamage = 3000, maxDamage = 7000, range = 7, radius = 3, shootEffect = 37, effect = 220, target = true },
{ name = "combat", interval = 2000, chance = 40, type = COMBAT_DEATHDAMAGE, minDamage = 3000, maxDamage = 7000, length = 8, spread = 0, effect = 205, target = false },
{ name = "combat", interval = 3000, chance = 40, type = COMBAT_PHYSICALDAMAGE, minDamage = 3000, maxDamage = 7000, length = 7, spread = 0, effect = 120, target = false },
{ name = "combat", interval = 2500, chance = 40, type = COMBAT_PHYSICALDAMAGE, minDamage = 3000, maxDamage = 7000, radius = 4, effect = 110, target = true },
{ name = "death chain", interval = 2500, chance = 40, minDamage = 3000, maxDamage = 7000, range = 7 },
{ name = "combat", interval = 3000, chance = 40, type = COMBAT_ICEDAMAGE, minDamage = 3000, maxDamage = 7000, range = 7, radius = 7, shootEffect = CONST_ANI_ICE, effect = 130, target = true },
{ name = "combat", interval = 2000, chance = 40, type = COMBAT_DEATHDAMAGE, minDamage = 3000, maxDamage = 7000, length = 8, spread = 0, effect = 190, target = false },
{ name = "combat", interval = 3000, chance = 40, type = COMBAT_FIREDAMAGE, minDamage = 3000, maxDamage = 7000, length = 8, spread = 0, effect = 200, target = false },
{ name = "combat", interval = 2000, chance = 40, type = COMBAT_ENERGYDAMAGE, minDamage = 3000, maxDamage = 7000, range = 7, radius = 3, shootEffect = CONST_ANI_FIRE, effect = 180, target = true },
{ name = "combat", interval = 2000, chance = 40, type = COMBAT_EARTHDAMAGE, minDamage = 3000, maxDamage = 7000, length = 8, spread = 0, effect = 195, target = false },
{ name = "combat", interval = 2000, chance = 40, type = COMBAT_HOLYDAMAGE, minDamage = 3000, maxDamage = 7000, length = 8, spread = 0, effect = 170, target = false },
...
monster.defenses = {
	...
	{ name = "speed", interval = 4000, chance = 80, speedChange = 700, effect = CONST_ME_MAGIC_RED, target = false, duration = 3000 },
}

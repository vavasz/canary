local mType = Game.createMonsterType("Enhanced Plunder Patriarch")
local monster = {}

monster.description = "an enhanced plunder patriarch"
...
monster.loot = {
	...
	{ name = "bag of enhanceds", chance = 100000, unique = true }, -- bag you desire
}

monster.attacks = {
	{ name = "melee", interval = 200, chance = 20, minDamage = 0, maxDamage = -9500 },
	{ name = "combat", interval = 2000, chance = 30, type = COMBAT_FIREDAMAGE, minDamage = -6000, maxDamage = -10000, target = true },
	{ name = "combat", interval = 2000, chance = 25, type = COMBAT_FIREDAMAGE, minDamage = -5000, maxDamage = -7000, length = 5, spread = 2, effect = CONST_ME_FIREAREA, target = false },
}

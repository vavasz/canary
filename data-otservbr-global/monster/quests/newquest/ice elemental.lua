...
monster.description = "a ice elemental"
...
monster.attacks = {
	...
	{ name = "combat", interval = 4000, chance = 55, type = COMBAT_ICEDAMAGE, minDamage = -2550, maxDamage = -4700, range = 7, shootEffect = ICE, effect = CONST_ME_ICEDAMAGE, target = true },
	{ name = "combat", interval = 3000, chance = 23, type = COMBAT_ICEDAMAGE, minDamage = -2800, maxDamage = -4100, radius = 4, effect = CONST_ME_ICEAREA, target = false },
}

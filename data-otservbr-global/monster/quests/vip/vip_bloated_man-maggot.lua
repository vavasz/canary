local mType = Game.createMonsterType("Vip Bloated Man-Maggot")
local monster = {}

monster.description = "a vip bloated man-maggot"
...
monster.loot = {
	...
	{ name = "might ring", chance = 100000, maxCount = 1 },
	{ name = "small emerald", chance = 100000, maxCount = 5 },
	{ name = "rotten roots", chance = 100000, maxCount = 1 },
	{ name = "bloated maggot", chance = 100000, maxCount = 1 },
	{ name = "terra rod", chance = 100000, maxCount = 1 },
	{ name = "butcher's axe", chance = 100000, maxCount = 1 },

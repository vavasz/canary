local mType = Game.createMonsterType("Vip Rotten Golem")
local monster = {}

monster.description = "a vip rotten golem"
...
monster.loot = {
	...
	{ name = "great spirit potion", chance = 100000, maxCount = 5 },
	{ name = "sacred tree amulet", chance = 100000 },
	{ name = "underworld rod", chance = 100000 },
	{ id = 281, chance = 100000 }, -- giant shimmering pearl
	{ name = "titan axe", chance = 100000 },
	{ name = "terra amulet", chance = 100000 },
	{ name = "mercenary sword", chance = 100000 },
	{ name = "war axe", chance = 100000 },
	{ name = "giant sword", chance = 100000 },
	{ name = "fur armor", chance = 100000 },
	{ name = "wood cape", chance = 100000 },
	{ name = "stone skin amulet", chance = 100000 },
	{ name = "terra mantle", chance = 100000 },
	{ name = "rubber cap", chance = 100000 },
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -1000, maxDamage = -1400, radius = 5, effect = CONST_ME_BIGPLANTS, target = false },
	...
	{ name = "poison chain", interval = 2000, chance = 20, minDamage = -1100, maxDamage = -1200, radius = 7, effect = CONST_ME_BIGPLANTS, target = false },

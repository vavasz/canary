local mType = Game.createMonsterType("Vip Mycobiontic Beetle")
local monster = {}

monster.description = "a vip mycobiontic beetle"
...
monster.loot = {
	...
	{ name = "serpent sword", chance = 100000 },
	{ name = "glacier mask", chance = 100000 },
	{ name = "small sapphire", chance = 100000, maxCount = 3 },
	{ name = "organic acid", chance = 100000, maxCount = 1 },
	{ name = "rotten roots", chance = 100000, maxCount = 1 },
	{ name = "scarab coin", chance = 100000, maxCount = 3 },
	{ name = "buckle", chance = 100000, maxCount = 1 },
	{ name = "rotten vermin ichor", chance = 100000, maxCount = 1 },
	{ name = "violet gem", chance = 100000 },
	{ name = "blue gem", chance = 100000 },
	{ name = "small ruby", chance = 100000, maxCount = 3 },
}
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -1200, maxDamage = -1500, radius = 5, effect = CONST_ME_GROUNDSHAKER, target = false },
	{ name ="largepoisonring", interval = 2000, chance = 10, minDamage = -900, maxDamage = -1400 },
}

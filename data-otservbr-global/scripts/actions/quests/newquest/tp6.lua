...
local portalifrit = MoveEvent()
function portalifrit.onStepIn(creature, item, position, fromPosition)
...
portalifrit:type("stepin")
portalifrit:position({ x = 954, y = 3087, z = 1 })
portalifrit:register()
local storagesTable = {
	{ storage = Storage.newquest.yojimboafter, bossName = "yojimbo" },
}

local tpafteryojimbo = MoveEvent()
function tpafteryojimbo.onStepIn(creature, item, position, fromPosition)
...
tpafteryojimbo:type("stepin")
tpafteryojimbo:position({ x = 763, y = 3124, z = 1 })
tpafteryojimbo:register()

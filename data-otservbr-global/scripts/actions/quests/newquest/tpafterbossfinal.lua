local storagesTable = {
	{ storage = Storage.newquest.valeforafter, bossName = "valefor" },
}

local tpafterfinal = MoveEvent()
function tpafterfinal.onStepIn(creature, item, position, fromPosition)
...
tpafterfinal:type("stepin")
tpafterfinal:position({ x = 160, y = 3143, z = 0 })
tpafterfinal:register()
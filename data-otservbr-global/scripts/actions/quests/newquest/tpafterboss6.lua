local storagesTable = {
	{ storage = Storage.newquest.ifritafter, bossName = "ifrit" },
}

local tpafterifrit = MoveEvent()
function tpafterifrit.onStepIn(creature, item, position, fromPosition)
...
tpafterifrit:type("stepin")
tpafterifrit:position({ x = 966, y = 3087, z = 1 })
tpafterifrit:register()
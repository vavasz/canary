local storagesTable = {
	{ storage = Storage.newquest.bahamuthafter, bossName = "bahamuth" },
}

local tpafterbahamuth = MoveEvent()
function tpafterbahamuth.onStepIn(creature, item, position, fromPosition)
...
tpafterbahamuth:type("stepin")
tpafterbahamuth:position({ x = 583, y = 3118, z = 1 })
tpafterbahamuth:register()
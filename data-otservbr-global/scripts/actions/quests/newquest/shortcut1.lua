local storagesTable = {
	{ storage = Storage.newquest.chaosshort, bossName = "chaos" },
}

local shortcutchaos = MoveEvent()
function shortcutchaos.onStepIn(creature, item, position, fromPosition)
...
shortcutchaos:type("stepin")
shortcutchaos:position({ x = 116, y = 3086, z = 0 })
shortcutchaos:register()
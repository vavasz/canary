local storagesTable = {
	{ storage = Storage.newquest.shivaafter, bossName = "shiva" },
}

local tpaftershiva = MoveEvent()
function tpaftershiva.onStepIn(creature, item, position, fromPosition)
...
tpaftershiva:type("stepin")
tpaftershiva:position({ x = 290, y = 3145, z = 1 })
tpaftershiva:register()
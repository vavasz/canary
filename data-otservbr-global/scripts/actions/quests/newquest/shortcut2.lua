local storagesTable = {
	{ storage = Storage.newquest.animashort, bossName = "anima" },
}

local shortcutanima = MoveEvent()
function shortcutanima.onStepIn(creature, item, position, fromPosition)
...
shortcutanima:type("stepin")
shortcutanima:position({ x = 116, y = 3090, z = 0 })
shortcutanima:register()
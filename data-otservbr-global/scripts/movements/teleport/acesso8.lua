local c = {
    ...
    secondTp = Position(1116, 171, 6), -- where the teleport that needs access sends the player
firstAid = 57015, -- actoin id of the first teleport
secondAid = 57016, -- actoin id of the second teleport
sto = 93117, -- storage that gives access

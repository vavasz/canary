local c = {
    ...
    secondTp = Position(768, 241, 0), -- where the teleport that needs access sends the player
firstAid = 57003, -- actoin id of the first teleport
secondAid = 57004, -- actoin id of the second teleport
sto = 93111, -- storage that gives access

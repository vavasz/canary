local c = {
    ...
    secondTp = Position(1035, 344, 5), -- where the teleport that needs access sends the player
firstAid = 57013, -- actoin id of the first teleport
secondAid = 57014, -- actoin id of the second teleport
sto = 93116, -- storage that gives access

...
secondTp = Position(991, 344, 4), -- where the teleport that needs access sends the player
firstAid = 57009, -- actoin id of the first teleport
secondAid = 57010, -- actoin id of the second teleport
sto = 93114, -- storage that gives access

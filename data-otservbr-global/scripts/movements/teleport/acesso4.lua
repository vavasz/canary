local c = {
    ...
    secondTp = Position(945, 98, 0), -- where the teleport that needs access sends the player
firstAid = 57007, -- actoin id of the first teleport
secondAid = 57008, -- actoin id of the second teleport
sto = 93113, -- storage that gives access

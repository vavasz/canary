local c = {
    ...
    secondTp = Position(786, 272, 1), -- where the teleport that needs access sends the player
firstAid = 57005, -- actoin id of the first teleport
secondAid = 57006, -- actoin id of the second teleport
sto = 93112, -- storage that gives access

local c = {
    ...
    secondTp = Position(712, 18, 0), -- where the teleport that needs access sends the player
firstAid = 57001, -- actoin id of the first teleport
secondAid = 57002, -- actoin id of the second teleport
sto = 93110, -- storage that gives access

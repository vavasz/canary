...
local function createMonsters(mountTable)
    for i = 1, #mountTable.name do
        ...
        local elementalFire = {
            name = {"fiery carnivor", "fire falcon defender", "ablazing mouth"},
            ltype = {1133, 1071, 1737},
        ...
        local elementalIce = {
            name = {"leaf carnysilvan", "forest guardian", "swamp fairy"},
            ltype = {1418, 1416, 1747},
        ...
        local elementalHoly = {
            name = {"fiery serpent", "enhanced exploder", "student of lava"},
            ltype = {1408, 876, 1279},
        ...
        local elementalEarth = {
            name = {"feiryst invader", "lamassu invader"},
            ltype = {980, 1190},
            idrace = {3507, 3508},
            lookBody = 7,
            lookLegs = 7,
